...
namespace Peacock.Common.Helper
{
    ...
    public static class CryptTools
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static string PagerNumEncrypt(int num, bool isThrowError = false)
        {
            // 分页加密密钥
        ...
        /// <param name="iv"></param>
        /// <returns></returns>
        public static string EncryptForIV(string toEncrypt, string key = "1234567812345678", string iv = "1234567812345678")
        {
        ...
        /// <param name="iv"></param>
        /// <returns></returns>
        public static string DecryptForIV(string toDecrypt, string key = "1234567812345678", string iv = "1234567812345678")
        {
            byte[] keyArray = UTF8Encoding.UTF8.GetBytes(key);
            byte[] ivArray = UTF8Encoding.UTF8.GetBytes(iv);
